...
<head>
	...
	<title>BNRGC - Nouveau mot de pass</title>
...
<body>
	...
	<div class="wrapper fadeInDown">
		<div id="formContent">
			...
			<div id="contentForm">
			<form action="<?= base_url("login/autoriser_modification_mot_pass")?>" method="POST">
				<input type="hidden" name="selector" value="<?=$selector?>">
					Votre password
					<input type="password" id="identity" class="fadeIn second" name="identity" placeholder="Pseudo">
