<form class="forms-sample" id="input-form"  url-save="assignerVoiture" url-get="getReservation">
    ...
    <div class="row">
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <input type="time" class="form-control input-form" name="voya_heure_depart"
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <input type="time" class="form-control input-form" name="voya_heure_arrivee"
                    placeholder="Nom et prenom de l'etudiant" required>
            </div>
            <div id="form-voiture_type_voiture" class="controlle-champ"></div>
            <input type="hidden" name="voya_date"  class="form-control input-form"/>
            <input type="hidden" name="poss_itine_id"  class="form-control input-form"/>

        </div>
        <div class="col-sm-5">
            <div class="form-group">
                <label>Choix de voiture</label>
                <select name="poss_voitu_id" id="" class="form-control input-form">
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <select name="voya_allee" id="" class="form-control input-form">
            ...
            <div class="form-group">
                ...
                <div class="" style='width: 100%;'>
                    <select name="passager_nom" id="passager_nombre" 
                        ...
                        style="width: 100%;" multiple="multiple" value="[]">
