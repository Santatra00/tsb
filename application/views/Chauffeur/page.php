                    ...
                    <tbody id="body-liste">
                        ...
                        ?>
                            <tr>
                                <td><?= $row->chauf_id?></td>
                                <td><?= $row->chauf_nom?></td>
                                <td><?= $row->chauf_prenom?></td>
                                <td><?= $row->chauf_tel?></td>
                                <td><?= $row->chauf_adresse?></td>
                                <td>
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <button type="button" class="btn btn-secondary btn-detail" id="<?= $row->chauf_id;?>">
                                            <i class="fa fa fa-address-card-o"></i>
                                        </button>
                                        <button type="button" class="btn btn-danger btn-supprimer" id="<?= $row->chauf_id;?>">
