                    ...
                    <tbody id="body-liste">
                        ...
                        ?>
                            <tr>
                                <td><?= $row->itine_id?></td>
                                <td><?= $row->itine_nom?></td>
                                <td><?= $row->itine_description?></td>
                                <td><?= $row->nb_point?></td>
                                <td>
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <button type="button" class="btn btn-secondary btn-detail" id="<?= $row->itine_id;?>">
